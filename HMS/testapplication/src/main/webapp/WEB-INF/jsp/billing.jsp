...
<div class="container">
	...
	<form:form onsubmit="return checkCard(this)" modelAttribute="bill" action="/billingDetails" method="post" autocomplete="off">
		...
		<fieldset class="form-group">
			...
			<fieldset class="form-group">
			<form:label path="description.patient.fullName">Patient Name</form:label>
			<form:input path="description.patient.fullName" type="text" class="form-control" disabled="true"/>
				<form:errors path="description.patient.fullName" cssClass="text-warning" />
			</fieldset>
